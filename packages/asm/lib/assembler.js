...
var Node = /** @class */ (function () {
    function Node(guard, location, options) {
        ...
        ethers_1.ethers.utils.defineReadOnly(this, "tag", "node-".concat(nextTag++, "-").concat(this.constructor.name));
...
function disassemble(bytecode) {
    ...
    while (i < bytes.length) {
        ...
        if (!opcode) {
            opcode = new opcodes_1.Opcode("unknown (".concat(ethers_1.ethers.utils.hexlify(bytes[i]), ")"), bytes[i], 0, 0);
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, logger.throwError("unable to assemble; ".concat(this.retry, " attempts failed to generate stable bytecode"), ethers_1.ethers.utils.Logger.errors.UNKNOWN_ERROR, {})];
                }
            });
        });
    };
